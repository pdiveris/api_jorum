  ...
  public function render() {
    ...
    switch ($this->getMimeType()) {
      ...
      case 'text/html':
        ...
        return \View::make('conversions.vfs')->with(array('bitstream'=>$this, 'vfs'=>\Jisc\apiHelpers::site2vfs($this)));
      ...
      case 'application/zip':
        return \View::make('conversions.zip')->with(array('bitstream'=>$this, 'vfs'=>\Jisc\apiHelpers::zip2vfs($this)));
        break;
      default:
